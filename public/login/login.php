...
<body>
    ...
    <header class="header__container">
        <nav class="header__navbar">
            ...
            <ul class="header__navItems">
                <li class="header__navLogin"><a href="<?php if (isset($_SESSION["id"])) { echo "../profile/profile.php"; } else{ echo "../login/login.php"; } ?>" aria-label="Login"><i class="fa-regular fa-user"></i></a></li>
            </ul>
        </nav>
    </header>
    ...
    <section class="login__container">
        <div class="login__formcontainer">
            ...
            <form class="login__form" action="login.php" method="POST">
                ...
                <div>
                    <p class="login__register">Don't have an account? <a style="text-decoration: underline;"
                            href="../register/register.php">Register here.</a></p>
                </div>
