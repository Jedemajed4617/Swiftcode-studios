    ...
    <section class="login__container">
        <div class="login__formcontainer">
            <form class="login__form" action="login.php">
                ...
                <div>
                    <p class="login__register">Heb je nog geen account? <a style="text-decoration: underline;" href="../register/register.php">Registreer hier.</a></p>
                </div>
                <label class="login__buttoncontainer" for="button">
                    <button id="button" class="login__button" type="submit">Inloggen</button>
                </label>
            </form>
        </div>
    </section>
